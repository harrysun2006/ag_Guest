...
public class ArticleContentTag extends TagSupport {

	private String _article;
	private static final Log _log = LogFactory.getLog(ArticleContentTag.class);
	...
	private void evaluate() throws JspException {
		...
		try {
			...
			r = JournalArticleLocalServiceUtil.getArticleContent(companyId, _article, locale.toString(), pathRoot);
		} catch(Exception e) {
