...
public class WeekTaskMailExcluder implements MailExcluder {
	...
	private boolean excludeByEmailAddress(Company company, String emailAddress) {
		boolean r = false;
		String emailAddressExclude = ConfigUtil.getConfig(Constants.EMAIL_ADDRESS_EXCLUDE_WEEK_TASK, company.getCompanyId());
