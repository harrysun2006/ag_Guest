...
<%@ page import="com.agloco.form.MyProfileChangeEmailForm" %>
...
<%
	MyProfileChangeEmailForm agMember = (MyProfileChangeEmailForm)request.getAttribute("myProfileChangeEmailForm");
%>

<form action="<portlet:actionURL windowState="<%= WindowState.MAXIMIZED.toString() %>"><portlet:param name="struts_action" value="/my_profile/my_profile_change_email" /></portlet:actionURL>" method="post" name="myProfileChangeEmailForm">
                  ...
                  <td valign="top"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="k11">
                      <tr>
                       ...
                       <tr>
                        ...
                        <td colspan="4" class="ag_k12"> <%=agMember.getMemberCode()%>
                        	<input name="<portlet:namespace />memberCode" type="hidden"  value="<bean:write name="myProfileChangeEmailForm" property="memberCode"/>">
                        </td>
                      
                      </tr>
                       <tr>
                        <td class="ag_k12" align="right"><%=LanguageUtil.get(pageContext,"ag-my-profile-member-previous-email-address") %>:</td>
                        <td colspan="4" class="ag_k12"> <%=agMember.getPreviousEmailAddress()%>
                        	<input name="<portlet:namespace />previousEmailAddress" type="hidden"  value="<bean:write name="myProfileChangeEmailForm" property="previousEmailAddress"/>">
                        </td>
                      ...
                      <tr>
                        <td class="ag_k12"><div align="right">
                            <div><span class="ag_k12"><%= LanguageUtil.get(pageContext, "ag-email") %></span><span class="ag_r11">*</span></div>
                        </div></td>
                        <td colspan="4" class="ag_r10b"><div align="left">
                             <input name="<portlet:namespace />newEmailAddress" type="text"  size="70" value="<bean:write name="myProfileChangeEmailForm" property="newEmailAddress"/>" maxlength="50"/>
                        </div></td>
                      </tr>
                      <tr>
                        <td class="ag_k12"><div align="right"><span class="ag_k12"><%= LanguageUtil.get(pageContext, "ag-confirm-email") %></span><span class="ag_r11">*</span></div></td>
                        <td colspan="4" class="ag_r10b"><div align="left">
                           <input name="<portlet:namespace />newEmailAddressCfm" type="text"  size="70" value="<bean:write name="myProfileChangeEmailForm" property="newEmailAddressCfm"/>" maxlength="50"/>
                        </div></td>
                      </tr>
                     
                      <tr>
                        <td class="ag_k12"><div align="right"></div></td>
                        <td colspan="2" class="ag_r10b">	
	                        <div align="left">
...
function formSubmit()
{
	var f = document.forms["myProfileChangeEmailForm"];
