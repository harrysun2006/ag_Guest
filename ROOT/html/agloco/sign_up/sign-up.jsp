...
<%
	...
	boolean regeralCodeVisible = true;

	if(referralCode != null && !"".equals(referralCode) && !"null".equals(referralCode)){
		regeralCodeVisible = false;
	}
%>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td align="right" valign="top" ><br>
        ...
        <tr>
          <td align="center">
            <%
            	if(regeralCodeVisible)
            	{
            %>
         		<img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-title-signup") %>" border="0">
         	 <%
            	}
            	else
            	{
            %>	
          		...
          		<img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-title-welcome-to-agloco") %>" width="682" height="31" border="0">
            <%
            	}
            %>
          </td>
        ...
        &nbsp;&nbsp;&nbsp;<img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-step1") %>" width="430" height="70" hspace="20">
        <table width="760" border="0" cellpadding="2" cellspacing="3" class="ag_k11">
          <tr>
            <td class="ag_k10b"><img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-spacer") %>" width="150" height="1"></td>

            <td class="ag_k10b"><img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-spacer") %>" width="150" height="1"></td>
            <td class="ag_k10b"><img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-spacer") %>" width="95" height="1"></td>
            <td class="ag_k10b"><img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-spacer") %>" width="180" height="1"></td>
            <td class="ag_k10b"><img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-spacer") %>" width="2" height="1"></td>
          </tr>
           ...
           <%
            ...
            %>
		      <tr>
	            <td rowspan="3"></td>
	            <td colspan="5" class="ag_k11"><%=LanguageUtil.get(pageContext,"ag-sign-up-referral-top-comment") %></td>
	          </tr>
	          <tr>
	            <td colspan="5" align="center" class="ag_k11"><a href="/web/guest/howitworks" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image271','','<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-button-learn-more-2") %>',1)"><img src="<%=LanguageUtil.get(pageContext,"ag-pic-sign-up-button-learn-more-1") %>" name="Image271" width="150" height="35" border="0" id="Image271"></a></td>
	          </tr>
            <%
            	}
            %>
          ...
          <tr>
            ...
            <td width="150" class="ag_k10b"><div align="right"></div></td>
            <td width="151" class="ag_k12"><div align="left"><span class="ag_r10b">*</span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-firstname") %>&#13;<br>
                    <input name="<portlet:namespace />firstName" type="text"  size="20" value="<bean:write name="signUpFrm" property="firstName"/>"/>
            </div></td>
            <td class="ag_k12"><div align="left"> <%= LanguageUtil.get(pageContext, "ag-middlename") %> <br>
                    <input name="<portlet:namespace />middleName" type="text"  size="3" value="<bean:write name="signUpFrm" property="middleName"/>"/>
            </div></td>

            <td width="180" class="ag_k12"><span class="ag_r10b">*</span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-lastname") %><br>
                <input name="<portlet:namespace />lastName" type="text"  size="20" value="<bean:write name="signUpFrm" property="lastName"/>"/></td>
            <td width="90" class="ag_k10b"><div align="left"></div></td>
          </tr>
          <tr>
            <td class="ag_k12"><div align="right">
                <div><span class="ag_r10b">*</span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-email") %>&#13;</div>

            </div></td>
            <td colspan="4" class="ag_k10b"><div align="left">
                <input name="<portlet:namespace />emailAddress" type="text"  size="40" value="<bean:write name="signUpFrm" property="emailAddress"/>" maxlength="50"/>
            </div></td>
          </tr>
          <tr>
            <td class="ag_k12"><div align="right"><span class="ag_r10b">*</span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-confirm-email") %></div></td>
            <td colspan="4" class="ag_k10b"><div align="left">

               <input name="<portlet:namespace />emailAddressCfm" type="text"  size="40" value="<bean:write name="signUpFrm" property="emailAddressCfm"/>" maxlength="50"/>
            </div></td>
          </tr>
          <tr>
            <td class="ag_k12"><div align="right">
                <div>
                  <div><span class="ag_r10b"></span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-date-of-birth") %>&#13;</div>
                  <div></div>

                </div>
            </div></td>
            <td colspan="4"><input name="<portlet:namespace />birthDate" type="text"  size="20" value="<bean:write name="signUpFrm" property="birthDate"/>" maxlength="10"/>
                <font class="ag_g11">&nbsp;&nbsp;<%= LanguageUtil.get(pageContext, "ag-date-of-birth-comment") %>&#13;</font> </td>
          </tr>
          <tr>
            <td class="ag_k12"><div align="right">
                <div><span class="ag_r10b">*</span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-city") %></div>

            </div></td>
            <td colspan="4" class="ag_k10b"><input name="<portlet:namespace />city" type="text"  size="25" value="<bean:write name="signUpFrm" property="city"/>"/></td>
          </tr>
          <tr>
            <td class="ag_k12"><div align="right"> <span class="ag_r10b">*</span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-state") %>&#13;</div></td>
            <td class="ag_k10b"><input name="<portlet:namespace />state" id="<portlet:namespace />state" type="text"  value="<% if(agMember.getState() == null || "".equals(agMember.getState().trim())) out.print(LanguageUtil.get(pageContext, "ag-none-if-not-applicable")); else out.print(agMember.getState()); %>" size="20" onclick="clearContext(this)"/>
           </td>
            <td class="ag_k12"><div align="right"><span class="ag_r10b">*</span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-zip-post-code") %></div></td>

            <td class="ag_k10b"><input name="<portlet:namespace />postCode" id="<portlet:namespace />postCode" type="text"  value="<% if(agMember == null || "".equals(agMember.getState().trim())) out.print(LanguageUtil.get(pageContext, "ag-none-if-not-applicable")); else out.print(agMember.getPostCode());  %>" size="20" onclick="clearContext(this)"/></td>
            <td class="ag_k10b">&nbsp;</td>
          </tr>
          <tr>
            <td class="ag_k12"><div align="right">
                <div><span class="ag_r10b">*</span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-country") %></div>
            </div></td>
            <td colspan="4" class="ag_k10b"><select id="<portlet:namespace />country" onChange="" name="country">
            ...
            %>
	          <tr>
	            <td class="ag_k12"><div align="right">
	                <div><span class="ag_r10b"></span>&nbsp;<%= LanguageUtil.get(pageContext, "ag-regerred-by") %></div>
	
	            </div></td>
	            <td colspan="4" class="ag_k10b"><input name="<portlet:namespace />referralCode2" type="text"  size="25" value="<bean:write name="signUpFrm" property="referralCode2"/>" maxlength="8"/><font class="ag_g11">&nbsp;&nbsp;<%= LanguageUtil.get(pageContext, "ag-regerred-by-comment") %>&#13;</font></td>
	          </tr>
            <%
            	}
          ...
          <tr>
            <td class="ag_k10b">&nbsp;</td>
            <td height="80" colspan="3" class="ag_k10b"><div align="center" style="cursor: hand">
            	<img src="<%= LanguageUtil.get(pageContext, "ag-pic-sign-up-button-join-now-a-new") %>" name="Image27" id="Image27" width="150" height="35" border="0" onclick="javascript:formSubmit();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image27','','<%= LanguageUtil.get(pageContext, "ag-pic-sign-up-button-join-now-b-new") %>',1)">
                      <!-- MENU-LOCATION=NONE -->
                      <!-- MENU-LOCATION=NONE -->
                      <!-- MENU-LOCATION=NONE -->
            </div></td>
...
<script>
	...
	{	
		...
		if(document.getElementById(portletId+"postCode").value == "<%=LanguageUtil.get(pageContext, "ag-none-if-not-applicable")%>"){
			document.getElementById(portletId+"postCode").value = "<%=LanguageUtil.get(pageContext, "ag-sign-up-none")%>";
			
		}
		if(document.getElementById(portletId+"state").value == "<%=LanguageUtil.get(pageContext, "ag-none-if-not-applicable")%>"){
			document.getElementById(portletId+"state").value = "<%=LanguageUtil.get(pageContext, "ag-sign-up-none")%>";
		}
