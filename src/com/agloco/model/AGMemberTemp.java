 ...
 *
 */
public class AGMemberTemp implements Serializable{

	public final static String DEFAULT_MEMBER_TEMP_STATUS_ACTIVE = "N";
	public final static String DEFAULT_MEMBER_TEMP_STATUS_INACTIVE = "S";
	 ...
	 */
	public void encrypt() {
		setEncReferralCode(CryptUtil.AESEncrypt(referralCode, key, charSet));
	...
	protected Blob getEncReferralCode() {
		return encReferralCode;
	}

	protected void setEncReferralCode(Blob b) {
		referralCode = CryptUtil.AESDecrypt(b, key, charSet);
		encReferralCode = b;
	}

	protected void setEncReferralCode(byte[] b) {
		encReferralCode = (b == null) ? null : new BlobImpl(b);
	}
